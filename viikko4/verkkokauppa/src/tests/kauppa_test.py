...
class TestKauppa(unittest.TestCase):
    ...
    def test_ylempi_mutta_tarkempi(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_aloita_nollaa(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("meeri", "121212")

        self.pankki_mock.tilisiirto.assert_called_with("meeri", ANY, "121212", "33333-44455", 5)
